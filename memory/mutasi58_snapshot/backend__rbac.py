...
ROLE_GRANTS = {
    ...
    "finance_manager": {
        ...
        # Fase 58: KERINGANAN denda keterlambatan (`late_fee:override`) adalah wewenang
        # Manajer Keuangan — bukan orang yang menagihkannya. Ditulis eksplisit karena
        # matriks RBAC yang sudah tersimpan di DB menimpa daftar izin per peran.
...
DEFAULT_PERMISSIONS = {
    ...
    # Manajer Keuangan) — keringanan adalah keputusan manajerial yang membalik jurnal dan
    # wajib beralasan tertulis. Sales boleh MELIHAT supaya bisa menjelaskan ke pembelinya.
    "late_fee": {
